                    ...
                    <form action="inserir_livro.php" method="post" enctype="multipart/form-data">
                        <fieldset>
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" id="compra" name="compra" class="form-control">
                          </div>
                          <div class="form-group">
                            <label for="resumo">Resumo do livro</label>
                            <textarea type="text" id="resumo" name="resumo" class="form-control" rows=10></textarea>
                          </div>

                          <div class="form-group">
                            <label for="imagem">Inserir capa do livro</label>
